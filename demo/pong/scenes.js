...
export const createTitleScene = (game, camera) => {
  ...
  menuWorld.addEntity(title);
  const option1 = new GameObject();
  option1.components.push(new MenuOptionComponent({ tag: MenuTypes.TITLE }));
  ...
  option2.components.push(new MenuOptionComponent({ tag: MenuTypes.TITLE }));
  ...
  option3.components.push(new MenuOptionComponent({ tag: MenuTypes.TITLE }));
...
export const createPlayScene = (game, camera) => {
  ...
  const finishWorld = playScene.createWorld();
